...
clf = joblib.load('../Fitness_Guardian/pushups/models/final_pushup_model_tune.pkl')

# def perform_manual_prediction(input_data):
...
# # Example input data
# input_data = [156, 157, 54.2, 55.82, 175.8, 178.15, 164.22, 166.43, 88.36, 81.93]

# # Perform manual prediction
# perform_manual_prediction(input_data)

# # Exit the program
# sys.exit()

# For Video
cap = cv2.VideoCapture("../Fitness_Guardian/Angle_Model/PoseVideos/pushUp42.mp4")
# For Camera
